import { buildErrorResponses, entregaHistoricoItemSchema, okResponseSchema, } from '../../swagger.js';
export async function registerAdminRoutes(app, options) {
    ...
    app.get('/documentos/:documentoNumero', {
        schema: {
            tags: ['Admin'],
