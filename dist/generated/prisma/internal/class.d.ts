 ...
 * `prisma.sessao`: Exposes CRUD operations for the **Sessao** model.
  ...
  */
    ...
    /**
     * `prisma.filaDocumento`: Exposes CRUD operations for the **FilaDocumento** model.
      * Example usage:
      * ```ts
      * // Fetch zero or more FilaDocumentos
      * const filaDocumentos = await prisma.filaDocumento.findMany()
      * ```
      */
    get filaDocumento(): Prisma.FilaDocumentoDelegate<ExtArgs, {
        omit: OmitOpts;
    }>;
    /**
    ...
    /**
     * `prisma.entregaItem`: Exposes CRUD operations for the **EntregaItem** model.
      * Example usage:
      * ```ts
      * // Fetch zero or more EntregaItems
      * const entregaItems = await prisma.entregaItem.findMany()
      * ```
      */
    get entregaItem(): Prisma.EntregaItemDelegate<ExtArgs, {
        omit: OmitOpts;
    }>;
    /**
    ...
    /**
     * `prisma.tentativaLoginAdmin`: Exposes CRUD operations for the **TentativaLoginAdmin** model.
      * Example usage:
      * ```ts
      * // Fetch zero or more TentativaLoginAdmins
      * const tentativaLoginAdmins = await prisma.tentativaLoginAdmin.findMany()
      * ```
      */
    get tentativaLoginAdmin(): Prisma.TentativaLoginAdminDelegate<ExtArgs, {
        omit: OmitOpts;
    }>;
    /**
     * `prisma.logAlteracao`: Exposes CRUD operations for the **LogAlteracao** model.
      * Example usage:
      * ```ts
      * // Fetch zero or more LogAlteracaos
      * const logAlteracaos = await prisma.logAlteracao.findMany()
      * ```
      */
    get logAlteracao(): Prisma.LogAlteracaoDelegate<ExtArgs, {
        omit: OmitOpts;
    }>;
}
